...
df_true = pd.read_csv('validation_true.csv')
df_pred = pd.read_csv('validation_pred.csv')
...
report_validation = classification_report(y_true, y_pred, target_names=cls_names, output_dict=True)
